---
title: Get Started with Dcup
description: This guide will help you set up Dcup—your self-hostable RAG-as-a-Service platform—and show you how to interact with its Retrieval API using JavaScript. (Cloud version coming soon!)
---
# 1. Installation
## Prerequisites
